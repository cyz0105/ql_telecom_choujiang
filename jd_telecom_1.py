...
def main(phone, password):
    apiType = 1
    try:
        url = "https://raw.githubusercontent.com/Yuning-lp/Hello-World/main/telecomLiveInfo.json"
...
if __name__ == '__main__':
    phone = get_environ("TELECOM_PHONE_1")
    password = get_environ("TELECOM_PASSWORD_1")
